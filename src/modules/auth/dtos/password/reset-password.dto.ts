...
import { RESET_PASSWORD_DOCS } from '@/auth/docs/constants/auth-password.constant';
...
const { NAME, DESCRIPTION, FIELDS } = RESET_PASSWORD_DOCS.REQUEST;

@ApiSchema({ name: NAME, description: DESCRIPTION })
export class ResetPasswordRequest {
  @ApiProperty({ description: FIELDS.TOKEN })
  @IsToken()
  public token!: string;
