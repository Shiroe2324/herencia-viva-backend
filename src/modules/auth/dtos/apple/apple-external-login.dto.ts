...
import { APPLE_EXTERNAL_LOGIN_DOCS } from '@/auth/docs/constants/auth-apple.constant';
import { EXPIRATION_TIME_EXAMPLE, JWT_TOKEN_EXAMPLE } from '@/constants';
import { IsToken } from '@/decorators';

const { REQUEST, RESPONSE } = APPLE_EXTERNAL_LOGIN_DOCS;

@ApiSchema({ name: REQUEST.NAME, description: REQUEST.DESCRIPTION })
export class AppleExternalLoginRequest {
...
export class AppleExternalLoginResponse {
